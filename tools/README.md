...
- ## **geoip-all.dat / geoip-all.db / geoip-all.metadb / Country-all.mmdb**

- Category：
  - `geoip:`[Click view](https://github.com/Loyalsoldier/v2ray-rules-dat)

- ## **geoip.dat / geoip.db / geoip.metadb / Country.mmdb**
...
- ## **geoip-lite.dat / geoip-lite.db / geoip-lite.metadb / Country-lite.mmdb**
...
- Category：
  - <del><code>geoip:private</code></del>
  - <del><code>geoip:cn</code></del>
  - `geoip:netflix`
  - `geoip:telegram`
